...
parser.add_argument("--qwen_long_context", action="store_true")
parser.add_argument(
    "--qwen_long_context_max_position_embeddings",
    type=int,
    default=131072,
)
parser.add_argument("--qwen_yarn_factor", type=float, default=4.0)
parser.add_argument(
...
parser.add_argument("--qwen3_long_context", action="store_true")
parser.add_argument(
    "--qwen3_long_context_max_position_embeddings",
    type=int,
    default=131072,
)
parser.add_argument("--qwen3_yarn_factor", type=float, default=4.0)
parser.add_argument(
    "--qwen3_original_max_position_embeddings",
    type=int,
    default=32768,
)
...
def get_llm(tokens_to_generate):
    ...
    if args.server_type == "hf":
        ...
        llm = HuggingFaceModel(
            ...
            top_k=args.top_k,
            top_p=args.top_p,
            qwen_long_context=args.qwen_long_context or args.qwen3_long_context,
            qwen_long_context_max_position_embeddings=(
                args.qwen_long_context_max_position_embeddings
                if args.qwen_long_context
                else args.qwen3_long_context_max_position_embeddings
            ),
            qwen_yarn_factor=(
                args.qwen_yarn_factor
                if args.qwen_long_context
                else args.qwen3_yarn_factor
            ),
            qwen_original_max_position_embeddings=(
                args.qwen_original_max_position_embeddings
                if args.qwen_long_context
                else args.qwen3_original_max_position_embeddings
            ),
            qwen3_long_context=args.qwen3_long_context,
            qwen3_long_context_max_position_embeddings=args.qwen3_long_context_max_position_embeddings,
            qwen3_yarn_factor=args.qwen3_yarn_factor,
            qwen3_original_max_position_embeddings=args.qwen3_original_max_position_embeddings,
            stop=args.stop_words,
            max_new_tokens=tokens_to_generate,
        )
        
    elif args.server_type == "SeerAttn":
        from model_wrappers import SeerAttnModel
        print("Using SeerAttnModel model:" , args.model_name_or_path)
        llm = SeerAttnModel(
            name_or_path=args.model_name_or_path,
            do_sample=args.temperature > 0,
            repetition_penalty=1,
